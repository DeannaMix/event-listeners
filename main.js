...
//   function third(hello, bye) {

//   }

//   const button = document.createElement('main-btn');
//   console.log(button);

//   let myBtn = document.querySelector("#main-btn")
//   console.log(myBtn);
...
//   const whatIsTheId = (e) => {
//       return `the element is is ${e.target.id}`;
//   }
    ...
    for (let i = 0; i < monkeyButts.length; i++) {
        domString += `<div class="card my-2" style="width: 18rem;" id="${i}">
                    <div class="img-container" style="background-image: url('${monkeyButts[i].imageUrl}')">
                        ...
                        <button><button type="button" class="btn btn-outline-dark" id="${i}">Delete</button></button>
                    </div>`
    }
